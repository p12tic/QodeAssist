...
if __name__ == "__main__":
 ...
 Language:  (MIME: text/python) filepath: /home/p12/code/my/checkouts/qtcreator-qodeassist/test/test_file.py(py)
...
{
    EXPECT_EQ(m_client->serverDeviceTemplate().toString(), "Qode Assist");
}
